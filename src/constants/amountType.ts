...
/**
 * Categorical slots 1-3 of the chart palette, in fixed order: colour follows
 * the amount type, never its size, so a filter can never repaint a series.
 * Validated as a set against the white card surface -- aqua lands under 3:1,
 * which is why every series always carries a visible value beside its swatch.
 */
